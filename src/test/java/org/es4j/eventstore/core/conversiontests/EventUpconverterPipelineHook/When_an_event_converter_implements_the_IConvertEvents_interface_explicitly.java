...
public class When_an_event_converter_implements_the_IConvertEvents_interface_explicitly extends UsingEventConverter {

    static final Commit       commit       = new Commit(UUID.randomUUID(), 0, UUID.randomUUID(), 0, new DateTime(0), null, null);
    static final UUID         id           = UUID.randomUUID();
    static final EventMessage eventMessage = new EventMessage(new ConvertingEvent2(id, "FooEvent"));
